...
//            for (String query : dimQueries) redshiftRA3Service.executeUpdate(query);
...
//            redshiftRA3Service.executeUpdate(j);
    ...
    public static void boastLoadRa3(){
        ...
        List<String> factTable = Arrays.asList("fact_ads_view", "fact_resource_log", "fact_action", "fact_retention", "fact_account_ads_view", "fact_session_time");
    ...
    public static void comparePerformanceBetweenRa3AndDc2() throws SQLException {
        ...
        try {
            for (int i = 0; i < dc2Threads.size(); i++) dc2Threads.get(i).join();
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        long endTime = System.currentTimeMillis();
        ...
        try {
            for (int i = 0; i < ra3Threads.size(); i++) ra3Threads.get(i).join();
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
    ...
    public static void testRa3PerformanceInRealSchema() {
        ...
        List<String> factTable = Arrays.asList("fact_ads_view", "fact_resource_log", "fact_action", "fact_retention", "fact_account_ads_view", "fact_session_time");
        Map<String, List<String>> days = new HashMap<>();
        days.put("fact_resource_log", Arrays.asList("2023-08-13", "2023-08-14", "2023-08-15", "2023-09-27", "2023-09-28", "2023-09-29", "2023-09-30", "2023-10-01", "2023-10-0",
                "2023-09-24","2023-09-20", "2023-10-09",
                "2023-08-27","2023-08-23","2023-08-26"));
        days.put("fact_session_time", Arrays.asList("2023-10-01", "2023-10-02", "2023-10-03","2023-10-04","2023-10-05","2023-09-24","2023-09-28", "2023-10-09"));
        days.put("fact_ads_view", Arrays.asList("2023-10-02", "2023-10-09", "2023-10-03", "2023-10-04","2023-10-01","2023-09-28","2023-09-29","2023-09-30","2023-09-26"));
        days.put("fact_action", Arrays.asList("2023-10-04", "2023-10-03","2023-10-05","2023-10-06", "2023-10-02", "2023-10-09"));
        days.put("fact_retention", Arrays.asList("2023-10-01", "2023-10-02", "2023-10-03","2023-10-04","2023-10-05", "2023-10-09", "2023-09-27","2023-09-28"));
        days.put("fact_account_ads_view", Arrays.asList("2023-10-02", "2023-10-03", "2023-10-04","2023-10-01", "2023-10-09", "2023-09-28","2023-09-29","2023-09-30","2023-09-26"));
        List<Thread> ra3Threads = new ArrayList<>();
        Set<String> visited = new HashSet<>();
        for (int i = 0; i < 5; i++) {
            String fact = factTable.get(rand.nextInt(factTable.size()));
            ...
            ra3Threads.add(new Thread(() -> {
                try {
                    createQuery(fact, "dwh_falcon_1", day, "Ra3");
                } catch (SQLException e) {
                    throw new RuntimeException(e);
                }
            }));
        ...
        long startTime = System.currentTimeMillis();
        for (int i = 0; i < ra3Threads.size(); i++) {
            ra3Threads.get(i).start();
        }
        try {
            for (int i = 0; i < ra3Threads.size(); i++) ra3Threads.get(i).join();
        } catch (InterruptedException e) {
    ...
    public static void main(String[] args) throws SQLException {
        preRun();
        createQuery("fact_ads_view","dwh_falcon_1","2023-10-02","Ra3");
    }
}
